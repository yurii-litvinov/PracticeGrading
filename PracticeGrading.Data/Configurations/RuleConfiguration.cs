    ...
    public void Configure(EntityTypeBuilder<Rule> builder)
    {
        ...
        builder.HasData(
            ...
            new Rule
            {
                Id = 2, Type = null,
                Description =
                    "достаточно понятна сфера применения, но нет указания на конкретных заинтересованных в работе или есть сомнения в полезности",
                Value = 4,
                IsScaleRule = true, CriteriaId = 1,
            },
            new Rule
            ...
            new Rule
            {
                Id = 6, Type = null, Description = "вообще не нужно", Value = 0, IsScaleRule = true, CriteriaId = 1,
            },
            new Rule
            {
                Id = 7, Type = "fixed",
            ...
            new Rule
            {
                Id = 12, Type = null, Description = "по ощущениям, делается средним второкурсником часов за 10",
            ...
            new Rule
            {
                Id = 14, Type = "range", Description = "за демонстрацию недостаточного погружения в предметную область",
                Value = -3, IsScaleRule = false, CriteriaId = 2,
            },
            new Rule
            {
                Id = 15, Type = null, Description = "по умолчанию", Value = 5, IsScaleRule = true, CriteriaId = 3,
            },
            new Rule
            {
                Id = 16, Type = "fixed", Description = "за отсутствие внятных выводов из обзора", Value = -1,
                IsScaleRule = false, CriteriaId = 3,
            },
            new Rule
            {
                Id = 17, Type = "range", Description = "за плохо оформленный текст отчёта", Value = -3,
                IsScaleRule = false, CriteriaId = 3,
            },
            new Rule
            {
                Id = 18, Type = "range", Description = "за отсутствие или некачественный обзор", Value = -4,
                IsScaleRule = false, CriteriaId = 3,
            },
            new Rule
            {
            ...
            new Rule
            {
                Id = 22, Type = "custom", Description = "за каждую минуту сверх 7 минут на выступление", Value = -1,
                IsScaleRule = false, CriteriaId = 4,
            },
            new Rule
            {
                Id = 23, Type = "fixed", Description = "за значимое количество опечаток на слайдах", Value = -1,
                IsScaleRule = false, CriteriaId = 4,
            },
            new Rule
            {
                Id = 24, Type = "fixed", Description = "за ошибки в представлении результатов экспериментов",
            ...
            new Rule
            {
                Id = 26, Type = "range", Description = "за недостаточно подробное изложение", Value = -5,
                IsScaleRule = false, CriteriaId = 4,
            },
            new Rule
            {
                Id = 27, Type = null, Description = "по умолчанию", Value = 5, IsScaleRule = true, CriteriaId = 5,
            },
            new Rule
            {
                Id = 28, Type = "custom",
