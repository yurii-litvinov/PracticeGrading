    ...
    public void Configure(EntityTypeBuilder<Rule> builder)
    {
        ...
        builder.HasData(
            ...
            new Rule
            {
                Id = 12,
                Type = null,
                Description = "по ощущениям, делается средним второкурсником часов за 10",
                Value = 1,
                IsScaleRule = true,
                CriteriaId = 2,
            },
            new Rule
            {
                Id = 13,
                Type = null,
                Description = "уровень домашней работы первого курса или сделано просто по учебнику",
                Value = 0,
                IsScaleRule = true,
                CriteriaId = 2,
            },
            new Rule
            {
                Id = 14,
                Type = "range",
                Description = "за демонстрацию недостаточного погружения в предметную область",
                Value = -3,
                IsScaleRule = false,
                CriteriaId = 2,
            },
            ...
            new Rule
            {
                Id = 16,
                Type = "fixed",
                Description = "за отсутствие внятных выводов из обзора",
                Value = -1,
                IsScaleRule = false,
                CriteriaId = 3,
            },
            new Rule
            {
                Id = 17,
                Type = "range",
                Description = "за плохо оформленный текст отчёта",
                Value = -3,
                IsScaleRule = false,
                CriteriaId = 3,
            },
            new Rule
            {
                Id = 18,
                Type = "range",
                Description = "за отсутствие или некачественный обзор",
                Value = -4,
                IsScaleRule = false,
                CriteriaId = 3,
            },
            ...
            new Rule
            {
                Id = 22,
                Type = "custom",
                Description = "за каждую минуту сверх 7 минут на выступление",
                Value = -1,
                IsScaleRule = false,
                CriteriaId = 4,
            },
            new Rule
            {
                Id = 23,
                Type = "fixed",
                Description = "за значимое количество опечаток на слайдах",
                Value = -1,
                IsScaleRule = false,
                CriteriaId = 4,
            },
            new Rule
            {
                Id = 24,
                Type = "fixed",
                Description = "за ошибки в представлении результатов экспериментов",
                Value = -1,
                IsScaleRule = false,
                CriteriaId = 4,
            },
            ...
            new Rule
            {
                Id = 26,
                Type = "range",
                Description = "за недостаточно подробное изложение",
                Value = -5,
                IsScaleRule = false,
                CriteriaId = 4,
            },
