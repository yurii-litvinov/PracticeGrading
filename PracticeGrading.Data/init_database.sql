...
CREATE TABLE "CriteriaGroup" (
                                 ...
                                 CONSTRAINT "PK_CriteriaGroup" PRIMARY KEY ("Id")
);
...
CREATE TABLE "CriteriaCriteriaGroup" (
                                         "CriteriaGroupsId" integer NOT NULL,
                                         "CriteriaId" integer NOT NULL,
                                         CONSTRAINT "PK_CriteriaCriteriaGroup" PRIMARY KEY ("CriteriaGroupsId", "CriteriaId"),
                                         CONSTRAINT "FK_CriteriaCriteriaGroup_CriteriaGroup_CriteriaGroupsId" FOREIGN KEY ("CriteriaGroupsId") REFERENCES "CriteriaGroup" ("Id") ON DELETE CASCADE,
                                         CONSTRAINT "FK_CriteriaCriteriaGroup_Criteria_CriteriaId" FOREIGN KEY ("CriteriaId") REFERENCES "Criteria" ("Id") ON DELETE CASCADE
);


CREATE TABLE "MarkScale" (
                             "Id" integer GENERATED BY DEFAULT AS IDENTITY,
                             "Min" double precision NOT NULL,
                             "Max" double precision NOT NULL,
                             "Mark" text NOT NULL,
                             "CriteriaGroupId" integer NOT NULL,
                             CONSTRAINT "PK_MarkScale" PRIMARY KEY ("Id"),
                             CONSTRAINT "FK_MarkScale_CriteriaGroup_CriteriaGroupId" FOREIGN KEY ("CriteriaGroupId") REFERENCES "CriteriaGroup" ("Id") ON DELETE CASCADE
);
...
CREATE TABLE "Meetings" (
                            ...
                            CONSTRAINT "FK_Meetings_CriteriaGroup_CriteriaGroupId" FOREIGN KEY ("CriteriaGroupId") REFERENCES "CriteriaGroup" ("Id") ON DELETE CASCADE
);
...
INSERT INTO "CriteriaGroup" ("Id", "MetricType", "Name")
VALUES (1, 1, 'Критерии для учебных практик');
...
INSERT INTO "CriteriaCriteriaGroup" ("CriteriaGroupsId", "CriteriaId")
VALUES (1, 1);
INSERT INTO "CriteriaCriteriaGroup" ("CriteriaGroupsId", "CriteriaId")
VALUES (1, 2);
INSERT INTO "CriteriaCriteriaGroup" ("CriteriaGroupsId", "CriteriaId")
...
INSERT INTO "MarkScale" ("Id", "CriteriaGroupId", "Mark", "Max", "Min")
VALUES (1, 1, 'A', 5.0, 4.5999999999999996);
INSERT INTO "MarkScale" ("Id", "CriteriaGroupId", "Mark", "Max", "Min")
VALUES (2, 1, 'B', 4.5, 4.0999999999999996);
INSERT INTO "MarkScale" ("Id", "CriteriaGroupId", "Mark", "Max", "Min")
VALUES (3, 1, 'C', 4.0, 3.6000000000000001);
INSERT INTO "MarkScale" ("Id", "CriteriaGroupId", "Mark", "Max", "Min")
VALUES (4, 1, 'D', 3.5, 3.1000000000000001);
INSERT INTO "MarkScale" ("Id", "CriteriaGroupId", "Mark", "Max", "Min")
VALUES (5, 1, 'E', 3.0, 2.6000000000000001);
INSERT INTO "MarkScale" ("Id", "CriteriaGroupId", "Mark", "Max", "Min")
VALUES (6, 1, 'F', 2.5, 0.0);
...
CREATE INDEX "IX_CriteriaCriteriaGroup_CriteriaId" ON "CriteriaCriteriaGroup" ("CriteriaId");
...
CREATE INDEX "IX_MarkScale_CriteriaGroupId" ON "MarkScale" ("CriteriaGroupId");


CREATE INDEX "IX_Meetings_CriteriaGroupId" ON "Meetings" ("CriteriaGroupId");
...
SELECT setval(
               ...
               false);
SELECT setval(
               pg_get_serial_sequence('"CriteriaGroup"', 'Id'),
               GREATEST(
                       (SELECT MAX("Id") FROM "CriteriaGroup") + 1,
                       nextval(pg_get_serial_sequence('"CriteriaGroup"', 'Id'))),
               false);
SELECT setval(
               ...
               false);
SELECT setval(
               pg_get_serial_sequence('"MarkScale"', 'Id'),
               GREATEST(
                       (SELECT MAX("Id") FROM "MarkScale") + 1,
                       nextval(pg_get_serial_sequence('"MarkScale"', 'Id'))),
               false);
SELECT setval(
