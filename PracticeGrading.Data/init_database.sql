...
CREATE TABLE "CriteriaMarkRule" (
                                    "CriteriaMarksId" integer NOT NULL,
                                    "SelectedRulesId" integer NOT NULL,
                                    CONSTRAINT "PK_CriteriaMarkRule" PRIMARY KEY ("CriteriaMarksId", "SelectedRulesId"),
                                    CONSTRAINT "FK_CriteriaMarkRule_CriteriaMark_CriteriaMarksId" FOREIGN KEY ("CriteriaMarksId") REFERENCES "CriteriaMark" ("Id") ON DELETE CASCADE,
                                    CONSTRAINT "FK_CriteriaMarkRule_Rule_SelectedRulesId" FOREIGN KEY ("SelectedRulesId") REFERENCES "Rule" ("Id") ON DELETE CASCADE
);
...
CREATE INDEX "IX_CriteriaMarkRule_SelectedRulesId" ON "CriteriaMarkRule" ("SelectedRulesId");
