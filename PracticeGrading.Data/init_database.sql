...
CREATE TABLE "AverageCriteriaMark" (
                                       ...
                                       CONSTRAINT "AK_AverageCriteriaMark_StudentWorkId" UNIQUE ("StudentWorkId"),
...
CREATE TABLE "MemberMark" (
                              ...
                              CONSTRAINT "FK_MemberMark_AverageCriteriaMark_StudentWorkId" FOREIGN KEY ("StudentWorkId") REFERENCES "AverageCriteriaMark" ("StudentWorkId") ON DELETE CASCADE,
...
CREATE TABLE "CriteriaMark" (
                                "MemberMarkId" integer GENERATED BY DEFAULT AS IDENTITY,
                                "MemberMarkMemberId" integer NOT NULL,
                                "MemberMarkStudentWorkId" integer NOT NULL,
                                "Mark" integer NOT NULL,
                                CONSTRAINT "PK_CriteriaMark" PRIMARY KEY ("MemberMarkId"),
                                CONSTRAINT "FK_CriteriaMark_MemberMark_MemberMarkMemberId_MemberMarkStuden~" FOREIGN KEY ("MemberMarkMemberId", "MemberMarkStudentWorkId") REFERENCES "MemberMark" ("MemberId", "StudentWorkId") ON DELETE CASCADE
);
...
CREATE TABLE "Rule" (
                        ...
                        "CriteriaId" integer NOT NULL,
                        "CriteriaMarkMemberMarkId" integer,
                        CONSTRAINT "PK_Rule" PRIMARY KEY ("Id"),
                        CONSTRAINT "FK_Rule_CriteriaMark_CriteriaMarkMemberMarkId" FOREIGN KEY ("CriteriaMarkMemberMarkId") REFERENCES "CriteriaMark" ("MemberMarkId"),
...
CREATE INDEX "IX_CriteriaMark_MemberMarkMemberId_MemberMarkStudentWorkId" ON "CriteriaMark" ("MemberMarkMemberId", "MemberMarkStudentWorkId");
...
CREATE INDEX "IX_Rule_CriteriaMarkMemberMarkId" ON "Rule" ("CriteriaMarkMemberMarkId");
