...
CREATE TABLE "AverageCriteriaMark" (
                                       ...
                                       CONSTRAINT "PK_AverageCriteriaMark" PRIMARY KEY ("StudentWorkId", "CriteriaId"),
...
CREATE TABLE "CriteriaMark" (
                                ...
                                "MemberId" integer NOT NULL,
                                "Mark" integer NOT NULL,
                                CONSTRAINT "PK_CriteriaMark" PRIMARY KEY ("StudentWorkId", "CriteriaId"),
                                CONSTRAINT "FK_CriteriaMark_AverageCriteriaMark_StudentWorkId_CriteriaId" FOREIGN KEY ("StudentWorkId", "CriteriaId") REFERENCES "AverageCriteriaMark" ("StudentWorkId", "CriteriaId") ON DELETE CASCADE,
                                CONSTRAINT "FK_CriteriaMark_Criteria_CriteriaId" FOREIGN KEY ("CriteriaId") REFERENCES "Criteria" ("Id") ON DELETE CASCADE,
                                CONSTRAINT "FK_CriteriaMark_MemberMark_MemberId_StudentWorkId" FOREIGN KEY ("MemberId", "StudentWorkId") REFERENCES "MemberMark" ("MemberId", "StudentWorkId") ON DELETE CASCADE,
                                CONSTRAINT "FK_CriteriaMark_StudentWork_StudentWorkId" FOREIGN KEY ("StudentWorkId") REFERENCES "StudentWork" ("Id") ON DELETE CASCADE,
                                CONSTRAINT "FK_CriteriaMark_Users_MemberId" FOREIGN KEY ("MemberId") REFERENCES "Users" ("Id") ON DELETE CASCADE
);
...
CREATE TABLE "Rule" (
                        ...
                        "CriteriaId" integer NOT NULL,
                        "CriteriaMarkCriteriaId" integer,
                        "CriteriaMarkStudentWorkId" integer,
                        CONSTRAINT "PK_Rule" PRIMARY KEY ("Id"),
                        CONSTRAINT "FK_Rule_CriteriaMark_CriteriaMarkStudentWorkId_CriteriaMarkCri~" FOREIGN KEY ("CriteriaMarkStudentWorkId", "CriteriaMarkCriteriaId") REFERENCES "CriteriaMark" ("StudentWorkId", "CriteriaId"),
...
CREATE INDEX "IX_CriteriaMark_MemberId_StudentWorkId" ON "CriteriaMark" ("MemberId", "StudentWorkId");
...
CREATE INDEX "IX_Rule_CriteriaMarkStudentWorkId_CriteriaMarkCriteriaId" ON "Rule" ("CriteriaMarkStudentWorkId", "CriteriaMarkCriteriaId");
