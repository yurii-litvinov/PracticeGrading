...
export function MemberPage() {
    ...
    return (
        <>
            ...
            {id && <MeetingAccessRequestsPanel meetingId={Number(id)} />}
            <hr className="my-4" />
            ...
            <div>
                <div className="d-flex p-2 align-items-center">
                    <div>
                        ...
                        <p className="small mb-0" style={{ color: "#9a9d9f" }}>
                            Для перехода к оцениванию нажмите на соответствующую
                            строку таблицы на вкладке «Работы студентов»
                        </p>
                    </div>
                </div>
            </div>
